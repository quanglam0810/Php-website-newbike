...
?>
<div align="center"><h1 style='font-size: 1.8em;color: #002142;margin-bottom: 10px;'>CHI TIẾT ĐƠN HÀNG <?php echo'#MSDH'; echo $id?></h1><a href='../admin/hoadon.php?in_hoadon=<?php echo$id ?>'>IN HÓA ĐƠN</a></div>
<table>
    <tr id='label'>
        <td>STT</td>
        <td>HÌNH ẢNH</td>       
    ...
    while ($dong_cart = mysql_fetch_array($run_cart)) {
        ...
        <tr text-aligament="ceter">
            ...
            <td><?php echo "#MSPS";echo $dong_cart['MaSP']; ?></td>

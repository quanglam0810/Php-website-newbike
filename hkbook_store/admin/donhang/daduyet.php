        ...
        while ($result = $list_dh->fetch_assoc()) {
            ...
            <tr class="odd gradeX"> 
                ...
                <td><form action="donhang/update.php" method="POST">                    
                    <button name ='vc' type='submit' value='<?php echo $result["MaDH"]?>'>Bàn Giao V/C</button>
                    </br>
                    <input type="text" name="magh" placeholder="Nhập mã vận đơn"></form>
                </td>
                <?php
            }
        }
...
<p style="color:red">Có <?php echo $dem;?> Đơn Hàng Đang chờ giao</p>
</table>
